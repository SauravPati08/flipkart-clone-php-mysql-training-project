					...
					echo '<div class="col-md-12">
							<div class="card">
								<div class="row">
									...
									<div class="col-md-3">
										<div class="p-5">
											<button class="btn btn-sm change-quantity" style="background-color:#FB641B; color:white;" data-id="'.$row['product_id'].'">-</button>
								...
								<div class="card-body">
									...
									<div class="row">
										...
										<div class="col-md-12">
											...
											<button class="btn btn-sm mt-2" id="coupon-btn" style="background-color:#FB641B; color:white;">Apply</button>
										</div>
										<div class="col-md-12">
											<button class="btn btn-block text-white mt-2" style="background-color:#2874F0;" id="checkout">Checkout</button>
										</div>
									</div>
