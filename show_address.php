						...
						echo '<div class="col-md-12 mt-3">
								<div class="card">
									<div class="card-body">
										...
										<a href="update_address.php?address_id='.$row['address_id'].'&order_id='.$order_id.'" class="btn btn-sm" style="background-color:#FB641B; color:white;">Select this address</a>
									</div>
								</div>
							</div>';
							$counter++;
